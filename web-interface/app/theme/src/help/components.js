  ...
  function groups() {
    return V.cN( {
      ...
      h: [
        ...
        {
          t: 'p',
          h: `Modelle zeigen immer nur eine Näherung an die Realität.
          Ergebnisse sind daher immer mit einem gewissen Fehler behaftet. Diese variiert von Standort zu
          Standort und kann daher nicht genau beziffert werden. Als Anhaltspunkt für die Bewertung gilt:
          Bilanzen &lt;0 zeigen möglicherweise eine Unterversorgung mit organischer Substanz an und
          sollten vermieden werden. Anzustreben sind Bilanzen &gt;0. Bei Bilanzen &gt;300 kg C ha-1a-1 sollte
          geprüft werden, ob die Gefahr von umweltschädlichen N-Verlusten besteht. Dies könnte der Fall
          sein, wenn das Ertragsniveau der Kulturen mittelfristig nicht ansteigt und keine Anhaltspunkte
          für einen tatsächlichen Humusaufbau beobachtet werden können.`,
        },
        {
          t: 'p',
