...
class BlockieAccountData extends Component {
  constructor(props) {
    super(props);
...
BlockieAccountData.contextTypes = {
  drizzle: PropTypes.object,
};

BlockieAccountData.propTypes = {
...
export default drizzleConnect(BlockieAccountData, mapStateToProps);
