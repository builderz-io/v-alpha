...
/**
    ...
    @dev Contract prioritised r
    eadability and testability over performance and
...
import "./lib/contracts-ethereum-package/math/Math.sol";
...
contract VICoin is Initializable, ERC20BurnableUpgradeSafe, FusedController {
    ...
    function initialize(
        ...
        public
        // ERC20BurnableUpgradeSafe.__ERC20_init(_name, _symbol)
        initializer
    {
        // ERC20BurnableUpgradeSafe.initialize(_name, _symbol);
    ...
    function getDecayedBalance(address _account) public view returns (uint256) {
        ...
        return balanceOf(_account).sub(decay);
    }
